...
<body>
    ...
    <main id="main">
        <section id="aWord ">
            ...
            // SQL query to select words starting with 'h' or 'H'
            $query = "SELECT * FROM pdf_files WHERE author LIKE 'H%'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <?php
                                        ...
                                        echo "No rows with column values containing 'H' found.";
                                    }
                                } else {
