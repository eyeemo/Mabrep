...
<body>
    ...
    <main id="main">
        <section id="cWord ">
            ...
            // SQL query to select words starting with 'c' or 'C'
            $query = "SELECT * FROM pdf_files WHERE author LIKE 'C%'";
                            ...
                            <div class="table-responsive">
                                <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                    ...
                                    <?php
                                            ...
                                            echo "No rows with column values containing 'C' found.";
                                        }
                                    } else {
