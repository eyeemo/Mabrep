    ...
    <main id="main">
        <section id="group">
            <div class="section-title">
                <h2>Information Technology & Artificial Intelligence</h2>
            </div>
            ...
            $query = "SELECT * FROM pdf_files WHERE subgroup = 'Information Technology & Artificial Intelligence' AND groupName = 'challenges'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $subgroup = str_ireplace('Information Technology & Artificial Intelligence', '<span class="highlight">Information Technology & Artificial Intelligence</span>', $row['subgroup']);
                                ...
                                <?php
                                        ...
                                        echo "No rows with subgroup 'Information Technology & Artificial Intelligence' found.";
                                    }
                                } else {
