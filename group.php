    ...
    <section id="group">
      <div class="section-title">
        ...
        <div class="ep_toolbox">
          <button type="button" class="btn btn-secondary btn-lg same-size" onclick="location.href='group_challenges.php'">Challenges</button>
          <button type="button" class="btn btn-secondary btn-lg same-size" onclick="location.href='group_solution.php'">Solution</button>
        </div>
      </div>
    </section>
