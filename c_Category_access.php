...
<body>
    ...
    <main id="main">
        <section id="group">
            ...
            // SQL query to select rows with subgroup 'Accessibility' and groupName 'solutions'
            $query = "SELECT * FROM pdf_files WHERE subgroup = 'Accessibility' AND groupName = 'challenges'";
