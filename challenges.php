...
<script>
    function goToNextPage() {
        window.location.href = "group.php"; // Replace with the desired URL
    }
</script>
        ...
        <div class="container d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li><a class="nav-link scrollto" href="#advance">Advance Search</a></li>
                    <li><a class="nav-link scrollto" href="search.php">Search</a></li>
                    <li><a class="nav-link scrollto" href="#years">Years</a></li>
                    <li><a class="nav-link scrollto" href="group.php">Group</a></li>
                </ul>
    ...
    <main id="main">
        <section id="aWord ">
            <div class="section-title">
                ...
                <button class="custom-button" onclick="goToNextPage()">Back</button>
            </div>
            <?php
            ...
            // SQL query to select words starting with 'a' or 'A'
            $query = "SELECT * FROM pdf_files WHERE groupName LIKE 'Challenges%'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <?php
                                        ...
                                        echo "No rows with column values containing 'A' found.";
                                    }
                                } else {
