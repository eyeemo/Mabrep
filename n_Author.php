...
<body>
    ...
    <main id="main">
        <section id="aWord ">
            ...
            // SQL query to select words starting with 'n' or 'N'
            $query = "SELECT * FROM pdf_files WHERE author LIKE 'N%'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <?php
                                        ...
                                        echo "No rows with column values containing 'N' found.";
                                    }
                                } else {
