...
<body>
    ...
    <main id="main">
        <section id="aWord ">
            ...
            // SQL query to select words starting with 'k' or 'K'
            $query = "SELECT * FROM pdf_files WHERE author LIKE 'K%'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <?php
                                        ...
                                        echo "No rows with column values containing 'K' found.";
                                    }
                                } else {
