    ...
    <main id="main">
        <section id="group">
            <div class="section-title">
                <h2>Health, Psychology & Human Development</h2>
            </div>
            ...
            $query = "SELECT * FROM pdf_files WHERE subgroup = 'Health, Psychology & Human Development' AND groupName = 'challenges'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <?php
                                        ...
                                        echo "No rows with subgroup 'Health, Psychology & Human Development' found.";
                                    }
                                } else {
