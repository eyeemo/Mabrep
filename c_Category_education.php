...
<body>
    ...
    <main id="main">
        <section id="group">
            ...
            $query = "SELECT * FROM pdf_files WHERE subgroup = 'Education & Training' AND groupName = 'challenges'";
                        ...
                        <div class="card-body">
                            <table class="table" id="myTable" style="display: flex-block;"> <!--table hide p/s ada dekat css-->
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            $subgroup = str_ireplace('Education & Training', '<span class="highlight">Education & Training</span>', $row['subgroup']);
                                ...
                                <?php
                                        ...
                                        echo "No rows with subgroup 'Education & Training' found.";
                                    }
                                } else {
